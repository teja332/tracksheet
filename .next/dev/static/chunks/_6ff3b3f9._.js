...
const NotificationProvider = ({ children })=>{
    ...
    const setCurrentUserIdWithStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "NotificationProvider.useCallback[setCurrentUserIdWithStorage]": (userId)=>{
            if (userId) {
    ...
    }["NotificationProvider.useCallback[setCurrentUserIdWithStorage]"], []);
...
_s(NotificationProvider, "JkTPWuDbYR/G17l6sV1xny+0duE=");
...
"[project]/components/FloatingNotificationDisplay.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function FloatingNotificationDisplay() {
    _s();
    const { notifications } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    const [floatingNotifications, setFloatingNotifications] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isMounted, setIsMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const processedIdsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(new Set());
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FloatingNotificationDisplay.useEffect": ()=>{
            setIsMounted(true);
        }
    }["FloatingNotificationDisplay.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FloatingNotificationDisplay.useEffect": ()=>{
            ...
            if (initialLoadRef.current) {
                notifications.forEach({
                    "FloatingNotificationDisplay.useEffect": (n)=>{
            ...
            const newNotifications = notifications.filter({
                "FloatingNotificationDisplay.useEffect.newNotifications": (n)=>!processedIdsRef.current.has(n.id)
            }["FloatingNotificationDisplay.useEffect.newNotifications"]);
            newNotifications.forEach({
                "FloatingNotificationDisplay.useEffect": (notification)=>{
                    ...
                    setFloatingNotifications({
                        "FloatingNotificationDisplay.useEffect": (prev)=>[
                                ...prev,
                                floatingItem
                            ]
                    }["FloatingNotificationDisplay.useEffect"]);
                    ...
                    const hideTimeout = setTimeout({
                        "FloatingNotificationDisplay.useEffect.hideTimeout": ()=>{
                            setFloatingNotifications({
                                "FloatingNotificationDisplay.useEffect.hideTimeout": (prev)=>prev.map({
                                        "FloatingNotificationDisplay.useEffect.hideTimeout": (n)=>n.id === notification.id ? {
                                                ...n,
                                                isVisible: false
                                            } : n
                                    }["FloatingNotificationDisplay.useEffect.hideTimeout"])
                    ...
                    }["FloatingNotificationDisplay.useEffect.hideTimeout"], 3000);
                    // Remove from floating after hide animation
                    const removeTimeout = setTimeout({
                        "FloatingNotificationDisplay.useEffect.removeTimeout": ()=>{
                            setFloatingNotifications({
                                "FloatingNotificationDisplay.useEffect.removeTimeout": (prev)=>prev.filter({
                                        "FloatingNotificationDisplay.useEffect.removeTimeout": (n)=>n.id !== notification.id
                                    }["FloatingNotificationDisplay.useEffect.removeTimeout"])
                            }["FloatingNotificationDisplay.useEffect.removeTimeout"]);
                        }
                    }["FloatingNotificationDisplay.useEffect.removeTimeout"], 3500);
                    return ({
                        "FloatingNotificationDisplay.useEffect": ()=>{
        ...
        switch(type){
            case "success":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                    ...
                    fileName: "[project]/components/FloatingNotificationDisplay.tsx",
                    lineNumber: 84,
                    columnNumber: 16
                }, this);
            case "error":
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed top-0 left-0 right-0 pointer-events-none z-[9999] flex items-start justify-center pt-6",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
            children: floatingNotifications.map((notification)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                    initial: {
                        opacity: 0,
                        y: -30,
                        scale: 0.9
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `max-w-md w-full mx-4 rounded-2xl border-2 bg-gradient-to-r ${getGradient(notification.type)} shadow-2xl p-6 flex items-start gap-4`,
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                onClick: ()=>{
                                    setFloatingNotifications((prev)=>prev.map((n)=>n.id === notification.id ? {
                                                ...n,
                                                isVisible: false
                                            } : n));
                                    setTimeout(()=>{
...
_s(FloatingNotificationDisplay, "2hn2T4zH3Hx9AhFTmSKTlFmefNk=", false, function() {
    return [
...
_c = FloatingNotificationDisplay;
var _c;
__turbopack_context__.k.register(_c, "FloatingNotificationDisplay");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/hooks/useSetCurrentUser.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useSetCurrentUser = ()=>{
    _s();
    const { setCurrentUserId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useSetCurrentUser.useEffect": ()=>{
            // Get the token from cookies
            const getCookie = {
                "useSetCurrentUser.useEffect.getCookie": (name)=>{
                    const value = `; ${document.cookie}`;
                    const parts = value.split(`; ${name}=`);
                    if (parts.length === 2) return parts.pop()?.split(";").shift();
                    return null;
                }
            }["useSetCurrentUser.useEffect.getCookie"];
            try {
...
_s(useSetCurrentUser, "tIcGtIX6qDkV0rMBeRcL6k7sHq0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"]
    ];
});
...
"[project]/components/UserInitializer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSetCurrentUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useSetCurrentUser.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
function UserInitializer() {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSetCurrentUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSetCurrentUser"])();
    return null;
}
_s(UserInitializer, "yJFVCWRLgLAmRkpudHEBf6xClII=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSetCurrentUser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSetCurrentUser"]
    ];
});
_c = UserInitializer;
var _c;
__turbopack_context__.k.register(_c, "UserInitializer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/contexts/NotificationContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$FloatingNotificationDisplay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/FloatingNotificationDisplay.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserInitializer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/UserInitializer.tsx [app-client] (ecmascript)");
"use client";
;
;
;
...
function LayoutWrapper({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserInitializer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/LayoutWrapper.tsx",
                lineNumber: 13,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$FloatingNotificationDisplay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/LayoutWrapper.tsx",
                lineNumber: 14,
                columnNumber: 7
            }, this),
...
//# sourceMappingURL=_6ff3b3f9._.js.map