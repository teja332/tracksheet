...
function signAuthToken(payload) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$jsonwebtoken$40$9$2e$0$2e$3$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign(payload, jwtSecret, {
        expiresIn: jwtExpiresIn
    });
}
function verifyAuthToken(token) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$jsonwebtoken$40$9$2e$0$2e$3$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, jwtSecret);
}
}),
...
"[project]/app/api/student/[rollNumber]/update/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    try {
        ...
        const cleanedUpdates = Object.fromEntries(Object.entries(config.updates).filter(([_, v])=>v !== undefined));
        const result = await collection.updateOne(config.query, {
            $set: cleanedUpdates
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d36dfa1b._.js.map